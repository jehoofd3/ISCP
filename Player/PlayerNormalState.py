...
class PlayerNormalState(PlayerState):
    ...
    def update(self):
        ...
        if pygame.key.get_pressed()[pygame.K_LEFT] != 0 and \
            ...
            # To set the face_direction variable to Left when the player is
            # going left.
        ...
        if pygame.key.get_pressed()[pygame.K_RIGHT] != 0 and \
            ...
            # To set the face_direction variable to right when the player is
            # going right.
        ...
        # To test if the player pressed on the up arrow key on the keyboard.
