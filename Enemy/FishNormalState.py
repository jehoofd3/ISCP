...
class FishNormalState(EnemyState):
    ...
    def __init__(self, enemy):
        ...
        # EnemyState so its required to call the super class
    ...
    def update(self):
        ...
        # This if statement checks if the x position of the fish is
        # smaller or equal than the x,
        ...
        # the x position of the fish is,
        # greater or equal than the x value on creation plus the range
        # of the fish.
        ...
        if self.move_left_right:
            # If its True, lower the x position of the fish with
            # the speed.
        ...
        # equal than switch_time start the FishJumpState.
        # This makes it jump every three seconds.
        if time.time() - self.start_time >= self.switch_time:
            # This line of code changes the object states to
            # FishJumpState so it changes the state.
