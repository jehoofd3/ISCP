...
class TankNormalState(EnemyState):
    ...
    def update(self):
        ...
        # This if statement checks if the x position of the tank is
        # smaller or equal than the x value on creation (enemy.stary_x).
        ...
        # the x position of the tank is greater or equal than the x
        # value on creation plus the range of the tank.
        ...
        if self.move_left_right:
            # If its True, lower the x position of the tank with
            # the speed.
            # This makes the tank move in the left direction.
            self.enemy.x_speed -= self.enemy.speed
        else:
            # If its False, add the speed with the x position of
            # the tank.
