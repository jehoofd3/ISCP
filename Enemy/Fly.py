...
class Fly(Enemy):
    ...
    def __init__(self, x, y, range):
        self.w_l[0] = (pygame.image.load("../Data/Images/Enemy/Fly/l_0.png").convert_alpha())
        self.w_l[1] = (pygame.image.load("../Data/Images/Enemy/Fly/l_1.png").convert_alpha())
        self.w_r[0] = (pygame.image.load("../Data/Images/Enemy/Fly/r_0.png").convert_alpha())
        self.w_r[1] = (pygame.image.load("../Data/Images/Enemy/Fly/r_1.png").convert_alpha())
