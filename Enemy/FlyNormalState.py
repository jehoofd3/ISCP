...
class FlyNormalState(EnemyState):
    ...
    def update(self):
        ...
        # This if statement checks if the x position of the fly is smaller or,
        ...
        # x position of the fly is greater or equal than the x value on,
        # creation plus the range of the fly.
        ...
        if self.move_left_right:
            # If its True, lower the x position of the fly with the speed.
        ...
        # to FlyAttackState.
        # This boolean is changed by the collider and lets the fly follow,
        # the player.
