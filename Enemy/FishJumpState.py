...
class FishJumpState(EnemyState):
    ...
    def update(self):
        ...
        # The state called the basic_movement and gravity method so
        # it can move on both axis.
        self.enemy.basic_movement()
        self.enemy.gravity()

        # When the current y position of the fish is greater or equal
        # than the y position on creation.
        # Execute the code.
