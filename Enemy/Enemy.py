...
class Enemy(object):
    ...
    # The four booleans block_u, block_d, block_r and block_l
    # indicates if the enemy is colliding with other objects.
    ...
    # The dead boolean is False if the enemy is alive and True if it
    # is dead an can be set by the collider or the enemy himself.
    # The follow boolean is a variable used by the follow state of a
    # enemy and is set by the collider.
    # If its True then the state of the enemy pushes its follow
    # state (if it has one).
    ...
    # When the enemy is in follow state, the collider checks if the
    # player is left or right, of the enemy.
    # If the player is on the right side of the enemy, left_right is True.
    # So the enemy moves to the right side.
    # If the player is on the left side of the enemy, left_right
    # is False.
    ...
    # The tank can shoot bullets, and these bullets need to be stored
    # in a list so they can be updated and drawn.
    bullet_list = []
    ...
    # It takes nine variables, the x and y are integers and used for
    # the location of the enemy.
    # The variable range is a integer and tells the enemy how far
    # he can move.
    # All the enemy's move left and right by default, this variable
    # tells him how far he can go.
    # The variables walk_l and walk_r are lists of images.
    # These images makes the animation of the enemy if he walks left
    # (walk_l) or right (walk_r).
    ...
    # When these images are colliding with the map or enemy, than the
    # collider set an action.
    ...
    def __init__(self, x, y, range, walk_l, walk_r, dead_l, dead_r, OB, LR):
        ...
        # The draw method in Artist needs this data to draw the
        # image properly.
        # The get_rect() method on the image only places the width
        # and height,
        # in the rect variable.
        self.rect = walk_l[0].get_rect()

        # The rect.x variable is a method to change the x variable
        # in rect.
        # Because the image doesn't have a x and y in the beginning,
        # it has to be changed in this way.
        self.rect.x = x

        # The rect.y variable is a method to change the y
        # variable in rect.
        # Because the image doesn't have a x and y in the beginning,
        # it has to be changed in this way.
        self.rect.y = y

        # The variables x_speed and y_speed are integers used for the
        ...
        # If its not set on 0 bij default then the enemy jumps when
        # he is created and not touching the ground.
        self.jumps_remaining = 0

        # This speed variable is a integer and is used to move the
        # enemy every frame two pixels.
        ...
        # When he goes back to his normal state, his speed is set back
        ...
        # When the enemy is in his normal state he moves on the x axis,
        # the range tells him how far he can go.
        # If the current X of the enemy is greater than the
        # start_x + range then he needs to move back.
        # If the current X of the enemt is smaller than the start_x,
        # he needs to move to the right side.
        self.start_x = x

        # Just like start_x, the start_y is used for the movement
        # of the enemy.
        # The Fish jumps after a few seconds, when his current y
        # position is greater than start_y his state changed
        ...
        # This object is used to calculate the enemy images so it
    ...
    def update(self):
        ...
        # These two line of code are changing the image used
        # for the colission.
        ...
        # This if statement checks if there is a block on the left
        # or right side of the enemy.
    ...
    def draw(self):
        ...
        # the x, y width and height of the enemy.
    ...
    def jump(self):
        # Because he can only jump one time, the variable
        # jumps_remaining must be higher than one.
        if self.jumps_remaining > 0:
            # If the enemy jumps, 10 will be added to his y_speed.
            self.y_speed += 10
            # If the enemy jumps, the variable jumps_remaining is
            # lowered by one, so it is zero and the enemy can't
            # jump again.
    ...
    def basic_movement(self):
        ...
        # then that value is added of extracted with the x position of
        # the enemy this position is stored in the rect list (rect.x).
        self.rect.x += self.x_speed

        # The y position of the enemy uses the same technique as
        # the x position.
        self.rect.y -= self.y_speed

        # It is important to set the x_speed back to zero,
        # or else the enemy will never stop moving on the x axis.
        self.x_speed = 0

        # Change the y_speed of the enemy if touches a tile with the
        # top of the image.
        # This will make the enemy to fall down 3 pixels.
        # If the speed is set on zero, the enemy will stick at the
        # bottom of a tile.
        if self.block_u:
            self.y_speed = - 3
