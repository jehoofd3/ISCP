...
class FlyAttackState(EnemyState):
    ...
    def __init__(self, enemy):
        ...
        # Multiple the speed of the fly by 1.2, so the fly moves faster when,
    ...
    def update(self):
        ...
        # Set the x speed of the fly to zero if he touches a tile on the left,
        ...
        # If the boolean follow in the enemy class is False, change the state,
        # back to FlyNormalState.
        # This variable is changed by the collider is the enemy is out of,
        # range (collider.range, not enemy.range).
